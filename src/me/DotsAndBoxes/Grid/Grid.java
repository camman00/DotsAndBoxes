...
public class Grid {
	...
	/**
	 * Space defines the amt of space vertically and horizontally
	 * Horizontal rows defines the amt of horizontal rows in the game
	 * Vertical rows defines the amt of vertical rows in the game
	 * @param space
